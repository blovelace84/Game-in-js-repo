...
`;var p0={fractal:{fragment:H0,settings:{sideCount:12,scale:.9,rotation:0}},crt:{fragment:V0,settings:{warp:.7,lineIntensity:.2,lineWidth:.6,lineCount:85}},neon:{fragment:B0,settings:{scale:.75,intensity:.8}},glow:{fragment:X0,settings:{intensity:.5}}},Y0=i=>{if("name"in i){let x=Object.assign({},p0[i.name].settings,i.settings);return {vertex:p0[i.name].vertex??m0,fragment:p0[i.name].fragment??d0,settings:x}}return {vertex:i.vertex??m0,fragment:i.fragment??d0,settings:i.settings}};var g0=class{canvas;#x;#t={};#i;#e;#r;#s;#o;#a=new Map;#n;constructor(x,e){if(this.#x=Y0(e),this.#x.settings)for(let n in this.#x.settings){let a=this.#x.settings?.[n];this.#t[n]=Array.isArray(a)?[...a]:a;}this.#i=x,this.canvas=b({id:M});let t=this.canvas.getWebglCtx();if(!t)throw new Error("WebGL not supported");this.#e=t;let r=this.#c(this.#e.VERTEX_SHADER,this.#x.vertex),s=this.#c(this.#e.FRAGMENT_SHADER,this.#x.fragment);this.#r=this.#l(r,s),this.#e.useProgram(this.#r),this.#n=this.#e.getAttribLocation(this.#r,"a_position"),this.#o=this.#u(),this.#s=this.#m(),this.#i.style.setProperty("display","none");}render(){this.canvas.show(),this.canvas.setSize(this.#i.width,this.#i.height),this.#d("size",[this.canvas.element.width,this.canvas.element.height]),this.#t&&Object.entries(this.#t).forEach(([x,e])=>{this.#d(x,e);}),this.#e.viewport(0,0,this.canvas.element.width,this.canvas.element.height),this.#e.clearColor(0,0,0,1),this.#e.clear(this.#e.COLOR_BUFFER_BIT),this.#h(),this.#e.bindBuffer(this.#e.ARRAY_BUFFER,this.#o),this.#e.enableVertexAttribArray(this.#n),this.#e.vertexAttribPointer(this.#n,2,this.#e.FLOAT,false,0,0),this.#e.drawArrays(this.#e.TRIANGLES,0,6);}setUniforms(x){for(let[e,t]of Object.entries(x))this.#t[e]=Array.isArray(t)?[...t]:t;}#c(x,e){let t=this.#e.createShader(x);if(this.#e.shaderSource(t,e),this.#e.compileShader(t),!this.#e.getShaderParameter(t,this.#e.COMPILE_STATUS)){let r=this.#e.getShaderInfoLog(t);throw this.#e.deleteShader(t),new Error(`Shader compilation failed:
